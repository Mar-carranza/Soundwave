...
function Join() { 
    return ( 
      <>
        <section id="join" style={{height: '100vh',gap:'5rem',padding:'2rem', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight:'100vh'}}>
          <Box className='textJoin' style={{display:'flex'}}>
            <Typography variant="h2" paragraph color='#fffff5' style={{fontWeight: "600", paddingTop:'2rem'}}>Join the <span style={{color: "#d3007b",fontWeight: "600"}}>fun.</span></Typography>
          </Box>
